...
public class Quiz {
	...
	Question trueorfalsequestion = new TrueFalseQuestion("The earth is the fourth planet from the sun?", "Y");
	trueorfalsequestion.check();
	
	Question trueorfalsequestion1 = new TrueFalseQuestion("The planet Venus has no moons", "N");
	trueorfalsequestion1.check();
	
	Question trueorfalsequestion2 = new TrueFalseQuestion("Jupiter is composed mostly of iron", "N");
	trueorfalsequestion2.check();
	
	Question trueorfalsequestion3 = new TrueFalseQuestion("The sun is a star of average size", "Y");
	trueorfalsequestion3.check();
	
	Question trueorfalsequestion4 = new TrueFalseQuestion("A lunar eclipse occurs when the sun passes", "N");
